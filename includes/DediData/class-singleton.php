...
abstract class Singleton {
	 ...
	 */
	final public function get( string $property_name ) {
	 ...
	 * @return void Return
	 */
	final public function set( string $property_name, $value ): void {
		$class_name = static::class;
		if ( ! property_exists( $class_name, $property_name ) ) {
	 ...
	 */
	final public static function get_instance( $param = null ) {
		$class_name = static::class;
	 ...
	 *
	 * @return mixed The object of class
	 */
	final protected static function use_instance_in_function_example() {
